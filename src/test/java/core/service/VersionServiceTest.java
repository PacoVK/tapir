...
class VersionServiceTest {
  ...
  void isValidModuleVersion() {
    ...
    assertFalse(VersionService.isValidModuleVersion("v1.0.0"));
  ...
  void isValidProviderVersion() {
    assertTrue(VersionService.isValidProviderVersion("1.0.0"));
    assertTrue(VersionService.isValidProviderVersion("2.1.3-alpha"));
    assertTrue(VersionService.isValidProviderVersion("0.0.1-beta+exp.sha.5114f85"));
    assertTrue(VersionService.isValidProviderVersion("1.0.0+20130313144700"));
    assertFalse(VersionService.isValidProviderVersion("v1.0.0"));
