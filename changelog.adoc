...
* https://github.com/PacoVK/tapir/pull/506[#493 - CosmosDB issues starting up container]

=== added

* Tapir exposes health check endpoints for monitoring and orchestration purposes
